...
Img = imread('bananas_equal_gray.jpg'); % real miscroscope image of cells
Img=double(Img(:,:,1));
%% parameter setting
...
iter_inner=7;
iter_outer=100;
lambda=5.0; % coefficient of the weighted length term L(phi)
alfa=2.5;  % coefficient of the weighted area term A(phi)
