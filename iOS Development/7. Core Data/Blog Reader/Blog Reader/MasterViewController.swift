...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let task = session.dataTaskWithURL(url!, completionHandler: { (data, reponse, error) -> Void in
            ...
            if error != nil {
                ...
                if jsonResult.count > 0 {
                    ...
                    if let items = jsonResult["items"] as? NSArray {
                        ...
                        // each time we run the app, the blog post will add to the database, we do not want this happen. All the blog posts will remove from the database before the new was added
    ...
    /// loop through everything in the core data entity and display on the table
